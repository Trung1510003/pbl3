...
export function setBackground()
{
  ...
  function onWindowResize() {
    camera.aspect = background.offsetWidth / background.offsetHeight;
    camera.updateProjectionMatrix();
    composer.setSize(background.offsetWidth, background.offsetHeight);
    renderer.setSize(background.offsetWidth, background.offsetHeight);
    bloomPass.setSize(background.offsetWidth, background.offsetHeight);
  }
